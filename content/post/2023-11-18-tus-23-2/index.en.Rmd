...
links:
 ...
 - icon: sistrix
   icon_pack: fab
   name: Outputs
   url: "https://github.com/AliGunerMD/aliguner/blob/main/content/post/2023-11-18-tus-23-2/outputs"
url_pdf: ""
url_code: ""
url_dataset: ""
url_project: ""
...
Branş-spesific sonuçları görmek için [Outputs](https://github.com/AliGunerMD/aliguner/blob/main/content/post/2023-11-18-tus-23-2/outputs) sayfasına;   
...
save_ggplot_for_branch <- function(branch_name) {
  ...
  ggsave(branch_plot,
    file = file.path("Outputs", paste0(branch_name, ".jpg")),
    dpi = 300,
    width = 9,
    height = 11
  )
